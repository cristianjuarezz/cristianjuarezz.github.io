    ...
    <>
      ...
      <section className='hero h-screen py-28 px-12 md:px-28 overflow-hidden md:overflow-visible mb-40 md:mb-0'>
        ...
        <div className='social flex justify-center gap-4 mt-6 invert'>
          <a className='text-2xl' href="https://www.linkedin.com/in/cristian-juarez-dev" target={'_blank'}>
          ...
          <a className='text-2xl' href="https://github.com/cristianjuarezz" target={'_blank'}>
          ...
          <a className='text-2xl' href="https://t.me/CristianJuarez" target={'_blank'}>
